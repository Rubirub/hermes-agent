...
from cron.scheduler import _resolve_origin, _resolve_delivery_target, _deliver_result, run_job, SILENT_MARKER, _build_job_prompt, tick
...
class TestParallelCronExecution:
    ...
    def test_stale_finalize_result_discarded(self):
        ...
        assert result is False
        finalize_mock.assert_called_once_with("job-1", "run-1", True, None)
    ...
    def test_output_is_saved_before_finalize(self):
        ...
        def fake_finalize(job_id, run_id, success, error):
